...
class IKRelKukaNutThreadEnvCfg(BaseNutThreadEnvCfg):
    ...
    def get_default_env_params(self):
        ...
        robot_params.arm_stiffness = robot_params.get("arm_stiffness", 250.0)
        ...
        rewards_params.action_rate_w = rewards_params.get("action_rate_w", -1e-4)
        rewards_params.action_l2_w = rewards_params.get("action_l2_w", -3e-3)
        rewards_params.contact_force_penalty_w = rewards_params.get("contact_force_penalty_w", -1e-3)
        rewards_params.incoming_wrench_mag_w = rewards_params.get("incoming_wrench_mag_w", -1e-3)
